$(document).ready(function() {
	...
	$('.timeline-graph').find('.semaine').click(function() {
		if($(this).hasClass('selected')) {	
			...
			$(".semaine").not($(this)).removeClass('selected');			
		}
	});
	...
	$('nav').find('.nav-item').click(function() {
		if($(this).hasClass('item-selected')) {	
			...
			$(".nav-item").not($(this)).removeClass('item-selected');			
		}

		if($(this).hasClass('open-twitter')) {
